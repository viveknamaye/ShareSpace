...
const GroupDetails = () => {
  const [group, setGroup] = useState({
    title: "FOR VRINDAVAN NIVAS",
    info: "Lorem ipsum dolor sit amet consectetur adipisicing elit Excepturi ratione",
    current: "4",
    limit: "6",
    members: [
      {
